...
(function() {
  ...
  this.usbmailactionFolderProps = {};

  // local shorthand for the global reference
  let self = this.usbmailactionFolderProps;
  ...
  self.onLoad = function onLoad(e) {
    ...
    if (row) {
      ...
      dialog.setAttribute("ondialogaccept", "usbmailactionFolderProps.onAcceptInherit();" +
...
window.addEventListener("load", function(e) { usbmailactionFolderProps.onLoad(e); }, false);
